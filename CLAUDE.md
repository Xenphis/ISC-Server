...
**`client/`** — git submodule (github.com/Xenphis/ISC-Clients): client-side addons (Lua 5.1, WoW 3.3.5a); `client/AddOns/ISC` implements the ISC protocol (server side: `src/server/game/Server/Protocol/Isc*`).
